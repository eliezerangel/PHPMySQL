...
<nav class="navbar navbar-expand-lg navbar-light bg-light" role="navigation">
        <div class="container padding-top: 60px;">
          <a class="navbar-brand" href="index.php?p=home"><i><img src="img/favicon/favicon-32x32.png" alt=""></i> Francisco Pereira <i class="far fa-registered"></i></a>          
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="index.php?p=about">Sobre</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="index.php?p=contact">Contacto</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="index.php?p=oportunity">Oportunidades</a>
              </li>              
            ...
            <a class="nav-link" style="color: gray;" aria-current="page" href="index.php?p=login">login</a>              
